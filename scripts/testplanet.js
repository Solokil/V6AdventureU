...
const testplanet = new JavaAdapter(Planet, {}, "tesplanet", Planets.serpulo, 0.4, 0.2); //4,0.7
testplanet.localizedName = "First Moon base";
testplanet.orbitRadius = 4.0;
testplanet.meshLoader = () => new SunMesh(testplanet, 4, 5, 0.3, 0.7, 0.6, 0.5, 1.5, Color.valueOf("f5d300"), Color.valueOf("74737a"), Color.valueOf("00aSe3"));
...
const zone1 = Vars.content.getByName(ContentType.block, "V6AdventureU-zonetest1");
